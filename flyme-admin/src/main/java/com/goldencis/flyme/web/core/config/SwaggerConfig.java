package com.goldencis.flyme.web.core.config;
...
public class SwaggerConfig
{
    /** 系统基础配置 */
    @Autowired
    private RuoYiConfig flymeConfig;
    ...
    public Docket createRestApi()
    {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                // 扫描指定包中的swagger注解
                // .apis(RequestHandlerSelectors.basePackage("com.flyme.project.tool.swagger"))
    ...
    private ApiInfo apiInfo()
    {
        ...
        return new ApiInfoBuilder()
                ...
                // 作者信息
                .contact(new Contact(flymeConfig.getName(), null, null))
                // 版本
                .version("版本号:" + flymeConfig.getVersion())
                .build();
    }
}
